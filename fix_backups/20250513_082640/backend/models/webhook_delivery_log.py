...
class WebhookDeliveryLog(Base):
    ...
    event_type = Column(String(100), nullable=False)  # e.g., order.created, payment.success
    ...
    def __repr__(self):
        return f"<WebhookDeliveryLog(user_id={self.user_id}, event='{self.event_type}', success={self.success})>"
