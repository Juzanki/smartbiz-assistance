...
class PostLog(Base):
    ...
    platform = Column(String(50), nullable=False)  # telegram, whatsapp, instagram, etc.
    ...
    def __repr__(self):
        return f"<PostLog(user_id={self.user_id}, platform='{self["platform"]}', status='{self["status"]')>"
